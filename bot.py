...
bot.activity = discord.Activity(type=discord.ActivityType.watching, name=F"@{bot.user.display_name} for prefix | {bot.prefix} help for help | Made by lvlahraam#8435")
